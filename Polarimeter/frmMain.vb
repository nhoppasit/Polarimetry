...
#Region "Sub-Routine"
    ...
    Private Sub DefineAngleOfRotation()
        ...
        If SelectedIndex = 0 Then
            lvi.SubItems(1).Text =
                "(" &
                TheData.Reference.Xm.ToString("0.00") &
                ", " &
                TheData.Reference.Ym.ToString("0.0000") &
                ")"
        Else
            lvi = lvSummary.Items(SelectedIndex)
            lvi.SubItems(1).Text =
                "(" &
                TheData.Data(SelectedIndex - 1).Xm.ToString("0.00") &
                ", " &
                TheData.Data(SelectedIndex - 1).Ym.ToString("0.0000") &
                ")"
...
#Region "Summary"
    ...
    Private Sub lvSummary_ItemSelectionChanged(ByVal sender As Object, ByVal e As System.Windows.Forms.ListViewItemSelectionChangedEventArgs) Handles lvSummary.ItemSelectionChanged
        ...
        Try
            If SelectedIndex = 0 Then
                lbISample.Text = "Reference"
            Else
                lbISample.Text = "Sample " & SelectedIndex.ToString
            End If
            ResetDynaplot()
            PlotReferenceCurve()
            PlotTreatmentsCurve()
