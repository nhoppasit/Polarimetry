...
namespace SRQEvent
{
	...
	/// </summary>
	public class SRQEvent : System.Windows.Forms.Form,IEventHandler
	{
		...
		private void InitializeComponent()
		{
			...
			System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(SRQEvent));
			...
			this.toolTip1.SetToolTip(this.btnStartReading, "Click the get the readings from the instrument");
			...
			this.Name = "SRQEvent";
			this.Text = "Agilent 34401A SRQEvent";
			this.Load += new System.EventHandler(this.SRQEvent_Load);
		...
		static void Main() 
		{
			Application.Run(new SRQEvent());
		}

		private void SRQEvent_Load(object sender, System.EventArgs e)
		{
			try
			{
			...
			{
				MessageBox.Show("FormattedIO488Class object creation failure. " + ex.Source + "  " + ex.Message, "SRQEvent", MessageBoxButtons.OK, MessageBoxIcon.Error); 
			}
			SetAccessForClosed();
		}
		...
		private void btnInitIO_Click(object sender, System.EventArgs e)
		{
			...
			{
				MessageBox.Show("Open failed on " + this.txtAddress.Text + " " + ex.Source + "  " + ex.Message, "SRQEvent", MessageBoxButtons.OK, MessageBoxIcon.Error); 
				ioDmm.IO = null;
			}
			txtData.Text = "";
		}
		...
		public void HandleEvent(IEventManager vi, IEvent @event, int userHandle)
		{
			...
			string sTemp;
			sTemp  = txtData.Text;
			txtData.Text = sTemp + "\r\n" + "SRQ fired, getting data " + DateTime.Now+ "\r\n";  
			ReadData();
			System.Windows.Forms.Cursor.Current = Cursors.Default;
		...
		private void StartReading()
		{
			...
			{
				MessageBox.Show("Error configuring the meter. " + this.txtAddress.Text + " " + ex.Source + "  " + ex.Message, "SRQEvent", MessageBoxButtons.OK, MessageBoxIcon.Error); 
			}		
		}
