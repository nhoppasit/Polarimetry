...
'     generator to output an FM waveform.
...
namespace FMmod
{
	...
	/// </summary>
	public class CFMmod : System.Windows.Forms.Form
	{
		...
		private System.Windows.Forms.Button m_setfmButton;
		...
		private void InitializeComponent()
		{
			...
			System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(CFMmod));
			...
			this.m_setfmButton = new System.Windows.Forms.Button();
			...
			this.toolTipCtrl.SetToolTip(this.m_closeioButton, "Close the IO enviornment");
			this.m_closeioButton.Click += new System.EventHandler(this.closeioButton_Click);
			// 
			// m_setfmButton
			// 
			this.m_setfmButton.Location = new System.Drawing.Point(6, 86);
			this.m_setfmButton.Name = "m_setfmButton";
			this.m_setfmButton.Size = new System.Drawing.Size(225, 27);
			this.m_setfmButton.TabIndex = 2;
			this.m_setfmButton.Text = "Set FM";
			this.m_setfmButton.Click += new System.EventHandler(this.m_setfmButton_Click);
			// 
			// groupBox1
			// 
			...
			this.label2.Text = "Press the \'Set FM\' button to configure the Function generator to give following o" +
				"utput:                Frequency modulated sine wave; Carrier - Sine 5kHz, 5Vpp ;" +
			...
			this.Controls.Add(this.m_setfmButton);
			...
			this.Text = "Agilent 33120A FM Mod";
			this.Load += new System.EventHandler(this.CFMmodulation_Load);
		...
		private void m_setioButton_Click(object sender, System.EventArgs e)
		{
			...
			{
				MessageBox.Show("Open failed on " + this.m_gpibAddrTextBox.Text + " " + ex.Source + "  " + ex.Message, "FM Modulation", MessageBoxButtons.OK, MessageBoxIcon.Error); 
				DisableControls();
				ioArbFG.IO = null;
            return;
			}
		...
		private void CFMmodulation_Load(object sender, System.EventArgs e)
		{
			DisableControls(); 
			ioArbFG = new FormattedIO488Class();
		}

		private void m_setfmButton_Click(object sender, System.EventArgs e)
		{
	        ioArbFG.WriteString("*RST",true);//' reset instrument
	        // Set up function generator to output FM waveform
			ioArbFG.WriteString("Output:load 50",true);//' set output termination to 50 ohm
			ioArbFG.WriteString("Apply:Sinusoid 5000,5",true);//' set carrier waveshape to sine, 5kHz, 5Vpp
			ioArbFG.WriteString("FM:Internal:Function Sin",true);//' modulation to sine
			ioArbFG.WriteString("FM:Internal:Frequency 200",true);//' Modulation frequency to 200Hz
			ioArbFG.WriteString("FM:Deviation 250",true);//' Frequency deviation 250Hz
			ioArbFG.WriteString("FM:State On",true);//' turn FM modulation on
		}
		...
		{
			this.m_setfmButton.Enabled = true;
		...
		{
			this.m_setfmButton.Enabled = false;
