...
#Region "Add new data thread"
    ...
    Public Sub AddNewPoint(ByVal timeStamp As DateTime, ByVal ptSeries As System.Windows.Forms.DataVisualization.Charting.Series)
        ...
        Dim removeBefore As Double = timeStamp.AddSeconds((CDbl(20) * -1)).ToOADate()
        ...
        Chart1.ChartAreas(0).AxisX.Maximum = DateTime.FromOADate(ptSeries.Points(0).XValue).AddSeconds(19).ToOADate()
